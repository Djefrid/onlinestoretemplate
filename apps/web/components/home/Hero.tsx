    ...
    <section className="relative flex min-h-[85vh] items-center overflow-hidden">
      ...
      <div className="container-page w-full">
        <div className="mx-auto max-w-3xl text-center">
          {/* Eyebrow */}
          <p className="mb-6 inline-flex items-center gap-2 rounded-full bg-accent/10 px-4 py-1.5 text-sm font-medium text-accent-dark">
          ...
          <h1 className="font-display text-4xl font-bold leading-tight tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
            ...
            <span className="text-accent">livrée à votre porte.</span>
          </h1>

          {/* Subtitle */}
          <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-foreground/60 sm:text-xl">
            Épices rares, produits frais et soins naturels importés directement
          ...
          {/* Trust signals */}
          <div className="mt-16 flex flex-wrap items-center justify-center gap-8 text-sm text-foreground/40">
