 ...
 * Utilisé par /api/auth/reset-password via supabase.auth.admin.generateLink()
 */
          ...
          <tr>
            <td style="background: #ffffff; padding: 40px; border-radius: 0 0 16px 16px;">
              ...
              <div style="text-align: center; margin-bottom: 32px;">
                <div style="display: inline-block; background: #fefce8; border-radius: 50%; width: 56px; height: 56px; line-height: 56px; font-size: 28px; margin-bottom: 16px;">🔐</div>
              ...
              <p style="margin: 24px 0 0; font-size: 12px; color: #b5afa9; text-align: center; line-height: 1.6;">
                ...
                <span style="color: #6858d8; word-break: break-all;">${data.resetUrl}</span>
              </p>
          ...
          <tr>
            <td style="padding: 24px 0; text-align: center;">
              ...
              <p style="margin: 4px 0 0; font-size: 12px; color: #c5bfb9;">
                Vous recevez cet email car une demande a été soumise depuis notre boutique.
              </p>
            </td>
          </tr>
